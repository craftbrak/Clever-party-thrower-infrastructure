# Automated build of HA `k3s` Cluster with `kube-vip`, `MetalLB`, `Cert-Manager`, `Traefik` , `Rancher` and `Longhorn`

![Fully Automated K3S etcd High Availability Install](https://img.youtube.com/vi/CbkEWcUZ7zM/0.jpg)

This playbook will build an HA Kubernetes cluster with `k3s`, `kube-vip`, `MetalLB`, `Cert-Manager`, `Traefik`, `Rancher` and `Longhorn` via `ansible`.
